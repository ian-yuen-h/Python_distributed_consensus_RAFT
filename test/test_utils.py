...
class Node:
    ...
    def start(self, sleep=0):
        self.startup_sequence = ["python3",
                                 ...
                                 self.config_path,
                                 str(self.i)]
        string1 = "stdout_capture"+str(self.i)+".txt"
        f = open(string1, "w")
        self.process = Popen(self.startup_sequence, stdout=f)
        # t1 = threading.Thread(target=track_output, args=(self.process))
        # t1.start()
